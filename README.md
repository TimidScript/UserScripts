...
#### NOTE: My OpenUserJS account has been removed. If you have downloaded any of my scripts from OpenUserJS, please redownload scripts from my [Greasy Fork](https://greasyfork.org/en/users/1455) account so update works.
